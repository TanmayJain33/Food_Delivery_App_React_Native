  ...
  function editOrder(action, menuId, price) {
    ...
    if (action == '+') {
      if (item.length > 0) {
        ...
        const newItem = {menuId: menuId, qty: 1, price: price, total: price};
    ...
    return (
      <View style={{flexDirection: 'row'}}>
        ...
        <View style={styles.restaurantNameView}>
          <View style={styles.restaurantNameInnerView}>
          ...
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Image
                source={icons.pin}
                resizeMode="contain"
                style={{width: 20, height: 20, tintColor: COLORS.darkGrey}}
              />
